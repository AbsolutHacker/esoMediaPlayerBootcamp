...
class SearchAlbumButton extends PlayerButton {
    ...
    public ActionListener[] getActionListeners() {
        ...
        actionListeners[0] = e -> {
            ...
            Launcher.getClient().subscribe(client -> {
//                Observable<ApiResponse> apiResponse$ = client.newRequest("/browse/album", albumName);
//                apiResponse$.subscribe(apiResponse -> {
//
//                });
            });
...
class SearchTrackButton extends PlayerButton {
    ...
    public ActionListener[] getActionListeners() {
        ...
        actionListeners[0] = e -> {
            ...
            Launcher.getClient().subscribe(client -> {
//                Observable<ApiResponse> apiResponse$ = client.newRequest("/browse/track", trackName);
//                apiResponse$.subscribe(apiResponse -> {
//
//                });
            });
...
class AlbumTracksButton extends PlayerButton {
    ...
    public ActionListener[] getActionListeners() {
        ...
        actionListeners[0] = e -> {
            ...
            Launcher.getClient().subscribe(client -> {
//                Observable<ApiResponse> apiResponse$ = client.newRequest("/browse/albumTracks", albumName);
//                apiResponse$.subscribe(apiResponse -> {
//
//                });
            });
