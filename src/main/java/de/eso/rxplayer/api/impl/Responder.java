...
public class Responder<E> implements Observer<List<E>> {
  ...
  public void onNext(List<E> o) {
    // jsonify the object
    // write it to a frame
    responseHandler.accept(new ApiResponse<E>(request, ApiResponse.Type.SUCCESS, o));
  }
  ...
  public void onError(Throwable e) {
    ...
    responseHandler.accept(new ApiResponse<E>(request, ApiResponse.Type.ERROR, null));
    e.printStackTrace();
